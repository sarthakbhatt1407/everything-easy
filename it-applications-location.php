...
<body>
  ...
  <section class="py-5">
    <div class="container">
      <div class="row mb-5">
        <div class="col-lg-8 mx-auto text-center">
          <h2 class="fw-bold mb-3">
            <i class="fas fa-globe text-primary me-3"></i>Application Development Services
          </h2>
          <p class="text-muted">
            Professional application development across India
          </p>
        </div>
      </div>
      ...
      // Fetch all locations
      $locations = mysqli_query($conn, "SELECT location_name, city_name , slug ,meta_title FROM locations_application ORDER BY id ASC");
      ?>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="service-card h-100 p-4 bg-white rounded shadow-sm">
              <h5 class="fw-bold mb-3">
                <a style="color: black; text-decoration: none;" href="/it-applications/<?php echo $loc['slug']; ?>">
