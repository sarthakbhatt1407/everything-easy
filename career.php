            ...
            >
              ...
              >
                <div class="flex-grow-1 mb-3 mb-md-0 w-100">
                  <div
                    class="d-flex flex-column align-items-center align-items-md-start mb-3"
                  >
                    <div
                  ...
                  <div class="mb-2">
                    <span
                      class="badge bg-primary bg-opacity-10 text-primary me-2 mb-2"
                      >React</span
                    >
                    <span
                      class="badge bg-primary bg-opacity-10 text-primary me-2 mb-2"
                ...
                <div class="align-self-center mt-3 mt-md-0">
                  <a href="#apply" class="btn btn-primary text-nowrap"
                    >Apply Now</a
                  >
                </div>
              </div>
            ...
            >
              ...
              >
                <div class="flex-grow-1 mb-3 mb-md-0 w-100">
                  ...
                  <div class="mb-2">
                    <span
                      class="badge bg-success bg-opacity-10 text-success me-2 mb-2"
                      >Figma</span
                    >
                    <span
                      class="badge bg-success bg-opacity-10 text-success me-2 mb-2"
            ...
            >
              ...
              >
                <div class="flex-grow-1 mb-3 mb-md-0 w-100">
                  ...
                  <div class="mb-2">
                    <span
                      class="badge bg-warning bg-opacity-10 text-warning me-2 mb-2"
                      >SEO</span
                    >
                    <span
                      class="badge bg-warning bg-opacity-10 text-warning me-2 mb-2"
            ...
            >
              ...
              >
                <div class="flex-grow-1 mb-3 mb-md-0 w-100">
                  ...
                  <div class="mb-2">
                    <span
                      class="badge bg-info bg-opacity-10 text-info me-2 mb-2"
                      >React Native</span
                    >
                    <span
                      class="badge bg-info bg-opacity-10 text-info me-2 mb-2"
