          ...
          <div class="hero-image text-center">
            <div class="image-stack">
              <img
                ...
                alt="Portfolio" class="img-fluid rounded shadow-lg portfolio-img-1" />
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="py-5 portfolio-section">
    <div class="container">
      <div class="row g-4 portfolio-masonry" id="portfolio-grid">
        <!-- Project 1 -->
        <div class="col-12 col-lg-6 portfolio-item" data-category="web design ecommerce">
          <div class="project-card">
            <div class="project-image">
              <img src="https://i.ibb.co/Zp25JnNs/Screenshot-2025-12-09-at-1-19-05-PM.png" alt="CEUTrainers Logo"
                class="img-fluid" />
